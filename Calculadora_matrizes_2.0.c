...
void leitura_da_matriz_e_do_escalar();
void menu();
void soma_matrizes();
...
void multiplicacao_por_escalar();
void mostrar_resultado_da_multiplicacao_por_escalar();

int main()
{
  int opcao;
  printf("1 - Operações entre matrizes \n");
  printf("2 - Multiplicação de matrizes por um escalar \n");
  scanf("%d", &opcao);
  ...
  if(opcao == 1)
  {
  ...
  } else
    {
      if(opcao == 2)
      {
        leitura_da_matriz_e_do_escalar();
      } else
        {
...
void leitura_de_numeros_das_matrizes(int quantidade_linhas_matriz_a, int quantidade_linhas_matriz_b, int quantidade_colunas_matriz_a, int quantidade_colunas_matriz_b)
{
  ...
  */
  ...
  menu(quantidade_linhas_matriz_a, quantidade_linhas_matriz_b, quantidade_colunas_matriz_a, quantidade_colunas_matriz_b, matriz_a, matriz_b);
}

void menu(int quantidade_linhas_matriz_a, int quantidade_linhas_matriz_b, int quantidade_colunas_matriz_a, int quantidade_colunas_matriz_b, int matriz_a[][quantidade_colunas_matriz_a], int matriz_b[][quantidade_colunas_matriz_b])
{
  int opcao;
  printf("----------------------------------------\n");
...
void leitura_da_matriz_e_do_escalar(int quantidade_linhas_matriz_a, int quantidade_colunas_matriz_a, int escalar)
{
  int posicao_linha, posicao_coluna;
  ...
  int matriz_a[quantidade_linhas_matriz_a][quantidade_colunas_matriz_a];

  printf("Insira o escalar que sera multiplicado a matriz \n");
  scanf("%d", &escalar);
  printf("----------------------------------------\n\n");
  ...
  for(posicao_linha = 0; posicao_linha < quantidade_linhas_matriz_a; posicao_linha ++)
  {
    for(posicao_coluna = 0; posicao_coluna < quantidade_colunas_matriz_a; posicao_coluna ++)
    {
      scanf("%d", &matriz_a[posicao_linha][posicao_coluna]);
    }
  }

  multiplicacao_por_escalar(quantidade_linhas_matriz_a, quantidade_colunas_matriz_a, matriz_a, escalar);
}

void multiplicacao_por_escalar(int quantidade_linhas_matriz_a, int quantidade_colunas_matriz_a, int matriz_a[][quantidade_colunas_matriz_a], int escalar)
{
  int posicao_linha, posicao_coluna, matriz_resultado[quantidade_linhas_matriz_a][quantidade_colunas_matriz_a];

  for(posicao_linha = 0; posicao_linha < quantidade_linhas_matriz_a; posicao_linha ++)
  {
    for(posicao_coluna = 0; posicao_coluna < quantidade_colunas_matriz_a; posicao_coluna ++)
    {
      matriz_resultado[posicao_linha][posicao_coluna] = escalar * matriz_a[posicao_linha][posicao_coluna];
    }
  }

  mostrar_resultado_da_multiplicacao_por_escalar(quantidade_linhas_matriz_a, quantidade_colunas_matriz_a, matriz_resultado);
}

void mostrar_resultado_da_multiplicacao_por_escalar(int quantidade_linhas_matriz_a, int quantidade_colunas_matriz_a, int matriz_resultado[][quantidade_colunas_matriz_a])
{
  int posicao_linha, posicao_coluna;

  printf("\n\n****************************************\n");
  printf("O resultado da multiplicação da matriz pelo escalar é: \n\n");
  printf("\n");
  for(posicao_linha = 0; posicao_linha < quantidade_linhas_matriz_a; posicao_linha ++)
  {
    for(posicao_coluna = 0; posicao_coluna < quantidade_colunas_matriz_a; posicao_coluna ++)
    {
      printf("%d", matriz_resultado[posicao_linha][posicao_coluna]);
      printf("\t");
    }
    printf("\n");
  }
